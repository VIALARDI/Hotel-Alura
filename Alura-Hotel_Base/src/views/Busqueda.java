...
public class Busqueda extends JFrame {
	...
	public Busqueda() {
		...
		lblNewLabel_4.setForeground(new Color(12, 180, 199));
		lblNewLabel_4.setFont(new Font("Roboto Black", Font.BOLD, 24));
		lblNewLabel_4.setBounds(331, 62, 350, 42);
		...
		btnEliminar.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				if(filaReservas >=0) {
					...
					JOptionPane.showMessageDialog(null, "Error al buscar, no se encontro");
				}
			}
		});
	 ...
	 private void headerMousePressed(java.awt.event.MouseEvent evt) {
	    	...
	    	try {
				for (Huespedes huespedes1 : huespedes ) {
					modeloH.addRow(new Object[] {
							huespedes1.getId(), huespedes1.getNombres(), huespedes1.getApellidos(),
	    ...
	    private void actualizarHuespedes() {
	    	...
	    	.ifPresentOrElse(filaHuespedes ->{
	    		...
	    		String nombres = (String) modeloH.getValueAt(tbHuespedes.getSelectedRow(), 1);
	    		String apellidos = (String) modeloH.getValueAt(tbHuespedes.getSelectedRow(), 2);
	    		...
	    		this.huespedesControl.actualizar(nombres, apellidos, fechaNacimiento, nacionalidad, telefono,id_reserva);
	    		JOptionPane.showMessageDialog(this, String.format("Registro Modificado con exito"));
